...
<div class="carousel-inner">
	<div class="carousel-item active">
		<img src="on-user/img/background.jpg">
	...
	<div class="carousel-item">
		<img src="on-user/img/background2.jpg">
		<div class="carousel-caption">
	...
	<div class="carousel-item">
		<img src="on-user/img/background3.jpg">
		<div class="carousel-caption">
...
<div class="row padding">
			<?php 	
            include "config.php" ;			
         			$qu=mysqli_query($dbconnect,"select gambar,nama_tanaman,harga from tanaman where stok between 20 and 25");
                     while($has=mysqli_fetch_row($qu))
                     {
						...
						<a href='aksi_keranjang_belanja.php' class='btn btn-outline-secondary'>Masukkan ke Keranjang</a>
						</div>
						</div>
						</div>
                        "; 
...
<div class=" row padding">
	...
	<div class="col-lg-6">
		<img src="on-user/img/desk.jpg" class="img-fluid">
	</div>
</div>
</div>
<hr class="my-4">
...
<div class=" row padding">
	...
	<div class="col-lg-6">
		<img src="on-user/img/boostrap2.jpg" class="img-fluid">
	</div>
</div>
</div>
