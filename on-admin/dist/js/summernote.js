...
(function (factory) {
  ...
  var range = (function () {
    ...
    var WrappedRange = function (sc, so, ec, eo) {
      ...
      this.pasteHTML = function (markup) {
        var contentsContainer = $('<div></div>').php(markup)[0];
  ...
  var defaults = {
     ...
     * @property {Object} [options.codemirror.phpMode=true]
  ...
  var History = function ($editable) {
    ...
    var applySnapshot = function (snapshot) {
      if (snapshot.contents !== null) {
        $editable.php(snapshot.contents);
      }
    ...
    this.undo = function () {
      ...
      if ($editable.php() !== stack[stackOffset].contents) {
        this.recordUndo();
      }
  ...
  var Editor = function (handler) {
    ...
    this.isEmpty = function ($editable) {
      return dom.isEmpty($editable[0]) || dom.emptyPara === $editable.php();
    };
  };
  ...
  var Popover = function () {
    ...
    this.update = function ($popover, styleInfo, isAirMode) {
      ...
      if (styleInfo.anchor) {
        ...
        $anchor.attr('href', href).php(href);
        if (!target) {
          $anchor.removeAttr('target');
        } else {
          $anchor.attr('target', '_blank');
  ...
  var Codeview = function (handler) {
    ...
    this.activate = function (layoutInfo) {
      ...
      $codable.val(dom.php($editable, options.prettifyHtml));
    ...
    this.deactivate = function (layoutInfo) {
      ...
      var isChange = $editable.php() !== value;
  ...
  var Clipboard = function (handler) {
    ...
    var pasteByHook = function (layoutInfo) {
      ...
      if (dom.isImg(node)) {
        ...
        var pasteContent = $('<div />').php($paste.php()).php();
        handler.invoke('restoreRange', $editable);
        handler.invoke('focus', $editable);
  ...
  var EventHandler = function () {
    ...
    this.attachCustomEvent = function (layoutInfo, options) {
      ...
      $editable.on(changeEventName, function () {
        bindCustomEvent($holder, callbacks, 'change')($editable.php(), $editable);
      });
  ...
  var Renderer = function () {
    ...
    var createPalette = function ($container, options) {
      ...
      $container.find('.note-color-palette').each(function () {
        ...
        $palette.php(paletteContents.join(''));
      });
    };
    ...
    this.createLayoutByFrame = function ($holder, options) {
      ...
      $editable.php(dom.php($holder) || dom.emptyPara);
    ...
    this.removeLayout = function ($holder, layoutInfo, options) {
      if (options.airMode) {
        ...
        $holder.php(layoutInfo.editable().php());
